...
1. Dari halaman Kontrol akses, pilih **View my access**.  Sebagai Administrator MOD, peran saat ini adalah Administrator layanan.  Ini akan memberi Anda izin yang diperlukan, tetapi penting untuk memahami peran spesifik Sentinel yang tersedia.  Tutup jendela penetapan Administrator MOD dengan mengeklik **X** di bagian pojok kanan atas halaman.
